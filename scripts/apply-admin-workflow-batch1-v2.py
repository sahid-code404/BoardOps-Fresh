...
# Reuse the already-staged batch patcher, but omit its stale Kitchen section.
...
# Remove this corrected one-shot wrapper and workflow too.
for transient in [
...
print("[BoardOps] corrected admin workflow batch one patch applied")
